          ...
          data.data.forEach((customer) => {
            const row = `
                    <tr>
                        ...
                        <td class="text-center" style="width: 15%;"><a href="viewcustomerprofile.html?id=${customer.customer_id}"><button type="button" class="vedbtns"><i class="fas fa-eye"></i></button></a></td>
                        <td class="text-center" style="width: 15%;"><button class="vedbtns edit-btn" data-toggle="modal" data-target="#edit-modal" data-customer-id="${customer.customer_id}" id="edit-btn-${customer.customer_id}"><i class="fas fa-edit"></i></button></td>
                        <td class="text-center" style="width: 15%;"><button class="vedbtns delete-btn" data-toggle="modal" data-target="#delete-modal" data-customer-id="${customer.customer_id}" id="delete-btn-${customer.customer_id}"><i class="fas fa-trash"></i></button></td>
                    </tr>
                `;
