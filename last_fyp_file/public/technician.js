          ...
          data.result.forEach((technician) => {
            const row = `
              <tr>
                ...
                <td class="text-center" style="width: 15%;"><a href="viewtechnicianprofile.html?id=${technician.technician_id}"><button type="button" class="vedbtns"><i class="fas fa-eye"></i></button></a></td>
                <td class="text-center" style="width: 15%;"><button type="button" class="vedbtns edit-btn" data-toggle="modal" data-target="#edit-modal" data-technician-id="${technician.technician_id}" id="edit-btn-${technician.technician_id}"><i class="fas fa-edit"></i></button></td>
                <td class="text-center" style="width: 15%;"><button type="button" class="vedbtns delete-btn" data-toggle="modal" data-target="#delete-modal" data-technician-id="${technician.technician_id}" id="delete-btn-${technician.technician_id}"><i class="fas fa-trash"></i></button></td>
              </tr>
            `;
